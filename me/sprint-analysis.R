...
list.of.packages <- c("dplyr", "tidyr", "ggplot2", "knitr", "markdown", "downloader", "sqldf", "lubridate", "zoo", "reshape")
...
sprint_results$Average <- rollmean(sprint_results$Velocity, 3, fill = "extend")
...
overall.velocity = mean(sprint_results$Velocity)
overall.velocity
#### ------------------------------------------------------------------------
