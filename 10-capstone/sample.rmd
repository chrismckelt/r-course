...
en_texts <- VCorpus(DirSource(directory="c:/dev/r-course/10-capstone/final/en_US/", encoding="UTF-8"), 
...
en_texts <- tm_map(x=en_texts, FUN=removeWords, words=stopwords(kind="english"))
